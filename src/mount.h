...
inline int merge_statfs_structs(const struct statfs *buf, struct statfs_ext *buf_full) {
...
/* used internally by statfs_ext() and getfsstat_ext() */
inline int read_proc_mounts(struct mounted_fs_entry *mnt_fs_buf, const char *path) {
    FILE *fp;
...
// extern inline int getmntpt(const char *path, char *mount_point) {
...
extern inline int getfsstat_ext(struct statfs_ext *struct_array_buf, const size_t bufsize) {
