...
PROGRAMS := arch basename base32 base64 cal cat chgrp chown cp df dirname env false fold free head link ln logname ls md5sum mount mkdir mv nl nproc od printenv pwd rm rmdir sha224sum sha256sum sha384sum sha512sum sleep stat sync tail tee touch true uname unlink uptime vdir wc who whoami yes
